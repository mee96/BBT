...
<img src="https://capsule-render.vercel.app/api?type=waving&color=f4b8d4&height=180&section=header&text=✦%20BUBBLE%20TEA%20API%20✦&fontColor=2d1b6e&fontSize=34&desc=una%20api%20kawaii%20per%20gestionar%20bubble%20teas&descSize=16&descColor=2d1b6e&descAlignY=65&fontAlignY=42" width="100%" alt="Bubble Tea API" />
...
**BubbleTea API** és un projecte full-stack que permet explorar, gestionar i degustar (virtualment) una col·lecció de 53 bubble teas.
...
*Per a **Firebase Admin** (necessaris per als endpoints protegits), afegeix la variable `FIREBASE_CREDENTIALS` amb el JSON del Service Account.*
...
* <img src="https://api.iconify.design/ph/coffee-fill.svg?color=%23E0A63B&height=18" height="16"> **53 Bubble Teas:** Catàleg complet amb categories, toppings i al·lèrgens.
